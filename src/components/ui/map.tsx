    ...
    <div className="absolute inset-0 flex items-center justify-center bg-white/80 backdrop-blur-sm z-50">
      <div className="flex flex-col items-center gap-4">
        <div className="flex gap-2">
          <span className="size-3 rounded-full bg-[#1B4F72] animate-bounce [animation-delay:-0.3s]" />
          <span className="size-3 rounded-full bg-[#5FB9C4] animate-bounce [animation-delay:-0.15s]" />
          <span className="size-3 rounded-full bg-[#1B4F72] animate-bounce" />
        </div>
        <p className="text-sm font-medium text-[#1B4F72] tracking-widest uppercase">Loading Map</p>
      </div>
    </div>
  );
}
